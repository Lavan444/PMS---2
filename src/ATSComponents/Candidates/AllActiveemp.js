...
// import NotesCandidate from "../Common/NotesCandidate"
...
//                                     <Dropdown
//                                       id="selectModule"
//                                       value={getSelectedTaskData()?.select_module || ''}

//                                       const options={[
//                                         { label: 'E-Commerce Platform', value: 'E-Commerce Platform' },
//                                         { label: 'HR Management System', value: 'HR Management System' },
...
//                                       value={getSelectedTaskData()?.estimated_work_hours || ''}
//                                       readOnly
//                                       placeholder=""
//                                       className="block w-full"
//                                     />
  ...
  const [documents, setDocuments] = useState([
{
  ...
  const [tasksData, setTasksData] = useState([
    ...
    {
      task_code: "Task-103",
      project_name: "Security Enhancement (Proj-103)",
